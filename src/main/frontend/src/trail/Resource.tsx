...
export function Resource({resource, selected, onClick}: {resource: IResource, selected: boolean, onClick: OnClickFunction}) {
    ...
    return <div onClick={onClick} className="flex items-center gap-2 w-full">
            <div className="">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                     strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 stroke-neutral-700 ">
