...
export function ProvenanceNode({provenance, templates}: { provenance: IProvenance, templates: ITemplate[] }) {
        ...
        return (<div
            ...
            <div className="w-full md:w-11/12 flex flex-col gap-4">
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <a href=""
                       className="w-full md:w-9/12 after:content-['→'] after:pl-1">https://github.com/HuygensING/republic-project/commit/581ff79d305262f3e4829b77ae5ee61d180e5037</a>
                </div>
            </div>
        </div>)
    }
    ...
    return (
        <>
            {/*<div*/}
            {/*    className="flex flex-col md:flex-row gap-6 border-b border-neutral-200 py-6 flex-wrap lg:flex-nowrap pl-6 md:pl-0 relative  after:content-['▲'] after:absolute after:bottom-0 after:text-neutral-200 after:text-xl after:-translate-x-2 after:translate-y-2">*/}
            {/*    <div className="w-1/2 md:w-1/12">*/}
            {/*        <div*/}
            {/*            className="p-1 border-neutral-200 rotate-45 -translate-x-10 md:-translate-x-4 inline-block bg-white border">*/}
            ...
            {/*    className="group flex flex-col md:flex-row gap-6 border-b border-l-2 border-neutral-300 border-b-neutral-200/70 py-6 flex-wrap lg:flex-nowrap pl-6 md:pl-0 relative bg-neutral-50 after:content-['▲'] after:absolute after:bottom-0 after:text-neutral-300 after:text-xl after:-translate-x-2 after:translate-y-2 relative">*/}
                <div className="absolute text-xs text-neutral-500 -translate-x-36 hidden group-hover:block">Provenance
                    event
                </div>
                <div className="w-1/2 md:w-1/12">
                    <div
                ...
                <div className="w-1/2 md:w-2/12 flex items-center">
                    <button
                        className="bg-neutral-100 hover:bg-neutral-200 transition text-sm rounded-full px-3 py-2">Script &rarr;</button>
                </div>
